...
app.on('ready', function () {
  ...
  ipc.on('update-check-manual', function (event, msg) {
    if (checkUpdate() === false) { // Returns true if update is available
      mainWindow.webContents.send('update-unrequired', 'version-current')
    }
  })
